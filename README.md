...
Features
- Historical food insecurity rates (2018–2020)
- Changes in food insecurity (2020–2023)
- Very low food security indicators
- State-level dummy variables
- Socioeconomic factors: poverty, unemployment, SNAP participation, median income
...
- Distribution plots for food insecurity metrics
- State-level comparison charts (Top 10 highest food insecurity rates)
- Correlation heatmap
